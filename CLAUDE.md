...
| ---|---|---|
| SendReminderJob
|Sends booking reminders via email/SMS
|notifications
|
| TranscodeJob
|Processes video files for web delivery
|media
|
| IngestMediaJob
|Handles media file ingestion and validation
|media
|
...
| ---|---|---|
| BookingMetrics
|Tracks booking-related metrics
|Status transitions, creation counts, sweeper results
|
| MediaMetrics
|Monitors media processing
|Transcode success/failure rates, processing times
|
| NotificationMetrics
|Tracks notification delivery
|Sent, failed, skipped counts by channel
|
Payment Integration
...
|
| SendReminderJob
|Queued job for reminder delivery
|
| Quiet hours support
